...
3. If any option is duplicated (i.e. `bash $ node cli -c C1-C1-A-R0 -c C0`) then **human-friendly** error should be printed in `stderr` and the process should exit with non-zero status code.
...
```bash
$ node cli -c "C1-C0-A-R1-R0-A-R0-R0-C1-A" -i "./input.txt" -o "./output.txt"
```
...
```bash
$ node cli -c "C1-R1-C0-C0-A-R0-R1-R1-A-C1" -i "./input.txt" -o "./output.txt"
```
...
============= can use =============
```bash
$ node cli -c "C1-R1-C0-C0-A-R0-R1-R1-A-C1" -i "./input.txt"
```
```bash
$ node cli -c "C1-R1-C0-C0-A-R0-R1-R1-A-C1" -o "./output.txt"
```

```bash
$ node  cli -o "./output.txt" -c "C1-R1-C0-C0-A-R0-R1-R1-A-C1" -i "./input.txt" 
```